<aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="dashboard.php">Shaheen ADMIN | </a>
...
<li class="menu-item-has-children dropdown">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-file-o"></i><a href="datainsertation.php">Add student</a></li>
                            <li><i class="menu-icon fa fa-file-o"></i><a href="editregsistration.php">Manage Student</a></li>
                        </ul>
                    </li>
<li class="active">
